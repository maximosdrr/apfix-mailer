...
var html_generator_1 = require("./html_generator");
...
var MailerService = /** @class */ (function () {
    ...
    MailerService.prototype.generateAnex = function (mailerObject) {
        return __awaiter(this, void 0, void 0, function () {
            var fileName, stream;
            return __generator(this, function (_a) {
                fileName = __dirname + "/output.html";
    ...
    MailerService.prototype.deleteAnex = function () {
        return __awaiter(this, void 0, void 0, function () {
            var fileName;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        fileName = __dirname + "/output.html";
                        return [4 /*yield*/, fs.unlink(fileName, function (err) {
                                if (err)
                                    throw err;
                            })];
                    case 1:
